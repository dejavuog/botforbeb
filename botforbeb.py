...
async def on_member_join(user=discord.Member):
    ...
    msg = "Alright {} listen up. You look like a fun guy which is why it'd be a shame to have to ban you so just go fucking read <#445135004826206209> and <#445135060702593025> you utter cunt and you won't wake up in a Taliban prison camp."
